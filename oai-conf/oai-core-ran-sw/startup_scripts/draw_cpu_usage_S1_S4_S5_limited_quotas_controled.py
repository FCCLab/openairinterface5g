...
# SCENARIO = [datetime(2024, 8, 19, 20, 30, 40, tzinfo=local_tz).astimezone(timezone.utc).isoformat(),
#               datetime(2024, 8, 19, 20, 32, 00, tzinfo=local_tz).astimezone(timezone.utc).isoformat()
#             ]

SCENARIO = [datetime(2024, 8, 19, 20, 48, 10, tzinfo=local_tz).astimezone(timezone.utc).isoformat(),
              datetime(2024, 8, 19, 20, 49, 40, tzinfo=local_tz).astimezone(timezone.utc).isoformat()
            ]

# SCENARIO = [datetime(2024, 8, 19, 21, 00, 40, tzinfo=local_tz).astimezone(timezone.utc).isoformat(),
#               datetime(2024, 8, 19, 21, 2, 40, tzinfo=local_tz).astimezone(timezone.utc).isoformat()
#             ]

# SCENARIO = [datetime(2024, 8, 19, 21, 24, 20, tzinfo=local_tz).astimezone(timezone.utc).isoformat(),
#               datetime(2024, 8, 19, 21, 25, 10, tzinfo=local_tz).astimezone(timezone.utc).isoformat()
#             ]
...
print("Average CPU Usage of oai-upf-slice-5:", average_upf_slice_5)
...
plt.tight_layout()
plt.savefig('CPU_Usage_and_Throughput_with_S5_and_CPU_Control.pdf', format='pdf')
