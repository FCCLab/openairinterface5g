...
static void fix_tdd_pattern(NR_ServingCellConfigCommon_t *scc)
{
  ...
  if (scc->tdd_UL_DL_ConfigurationCommon->pattern1.ext1 != NULL) {
    if ((*scc->tdd_UL_DL_ConfigurationCommon->pattern1.ext1->dl_UL_TransmissionPeriodicity_v1530) > 1) {
      free(scc->tdd_UL_DL_ConfigurationCommon->pattern1.ext1->dl_UL_TransmissionPeriodicity_v1530);
      scc->tdd_UL_DL_ConfigurationCommon->pattern1.ext1->dl_UL_TransmissionPeriodicity_v1530 = NULL;
      free(scc->tdd_UL_DL_ConfigurationCommon->pattern1.ext1);
  ...
  if (scc->tdd_UL_DL_ConfigurationCommon->pattern2 != NULL) {
     ...
     *  as these shall not be encoded with default values in SIB1
     */
    if (scc->tdd_UL_DL_ConfigurationCommon->pattern2->ext1 != NULL
        && (*scc->tdd_UL_DL_ConfigurationCommon->pattern2->ext1->dl_UL_TransmissionPeriodicity_v1530) > 1) {
      free(scc->tdd_UL_DL_ConfigurationCommon->pattern2->ext1->dl_UL_TransmissionPeriodicity_v1530);
      scc->tdd_UL_DL_ConfigurationCommon->pattern2->ext1->dl_UL_TransmissionPeriodicity_v1530 = NULL;
      free(scc->tdd_UL_DL_ConfigurationCommon->pattern2->ext1);
