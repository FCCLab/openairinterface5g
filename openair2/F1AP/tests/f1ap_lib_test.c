...
static void test_f1ap_setup_request(void)
{
  /* allocate memory */
  /* gNB_DU_name */
  uint8_t *gNB_DU_name = (uint8_t *)calloc(strlen("OAI DU") + 1, sizeof(uint8_t));
  ...
  uint8_t *measurement_timing_information = (uint8_t *)calloc(measurement_timing_config_len, sizeof(uint8_t));
...
static void test_f1ap_setup_response(void)
{
  ...
  uint8_t *gNB_CU_name = (uint8_t *)calloc(len, sizeof(uint8_t));
...
static void test_f1ap_du_configuration_update(void)
{
  ...
  uint8_t *measurement_timing_config_mod = (uint8_t *)calloc(measurement_timing_config_len, sizeof(uint8_t));
  AssertFatal(measurement_timing_config_mod != NULL, "out of memory\n");
  strcpy((char *)measurement_timing_config_mod, s);
  /* TAC modify */
  uint32_t *tac = calloc(1, sizeof(uint32_t));
  ...
  *orig.cell_to_modify[0].sys_info = sys_info;
  ...
  f1ap_gnb_du_configuration_update_t decoded;
...
static void test_f1ap_cu_configuration_update(void)
{
  ...
  f1ap_gnb_cu_configuration_update_t decoded;
