...
static const char tx_pool_suffix[NV_IPC_MEMPOOL_NUM][NV_NAME_SUFFIX_MAX_LEN] = {"_tx_cpu_msg", "_tx_cpu_data", "_tx_cuda_data", "_tx_gpu_data"};
static const char rx_pool_suffix[NV_IPC_MEMPOOL_NUM][NV_NAME_SUFFIX_MAX_LEN] = {"_rx_cpu_msg", "_rx_cpu_data", "_rx_cuda_data", "_rx_gpu_data"};
